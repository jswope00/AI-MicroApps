...
SYSTEM_PROMPT = """"
Generate a structured summary from a medical document, organizing the content by specific
medical concerns or categories. Each category should have a clear heading. Beneath each
category, identify cases with a specific identifier and title. 

Importantly, provide a Likert Score (-1, 0, +1) in the context of the cases and
symptoms/findings. 

Generate a brief summary of the medical case with the initial diagnosis, and present the additional complicating factor along with a likert score of the likelihood that the new information increases (+1), decreases (-1), or does not affect(0) the initial diagnosis. 
This approach aims to use medical knowledge to determine the impact of
the new information on the likelihood of the initial diagnosis. The Likert score has a value of -1, 0, or +1 where a
score of -1 decreases the likelihood of the diagnosis, and a score of +1 increases it. 
Example Output: 
"New Information: A past medical history of allergic rhinitis and asthma 
Likert Score: +1 
Diagnosis Probability 80-90%"
"""
...
PAGE_CONFIG = {
    "page_title": "MSC Tutor Experiment 2",
    "page_icon": "️🧑‍🏫",
    "layout": "centered",
...
TEMPLATES = {"MSC Tutor Experiment 2":"config_msct_tutor_experiment2"}
