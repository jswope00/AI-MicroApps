   ...
   "summarize": {
        ...
        "fields": {
            ...
            "multimedia_principle": {
                ...
                "value": "The multimedia principle is the idea that learner's retain information better when viewing images that match the audio, rather than audio alone. In my own work, I expect that I might try to use images that support the audio instead of purely decorative images or \"talking head\" format. ",
            },
        ...
        "rubric": """
            ...
            3. Animation vs Static
                1 points - The user has talked about when the multimedia principle advises when to use animation (primarily to illustrate hands-on procedures or to serve an interpretive function) vs static images (most other educational visualizations)
                0 points - The user has not spoken to when multimedia principle advises to use animation vs static images. 
        """,
    ...
    "improve": {
        ...
        "fields": {
            "multimedia_principle_revised": {
                ...
                "label_visibility": "hidden",
                "value": """The multimedia principle is the idea that learner's retain information better when viewing images that match the audio, rather than audio alone. This is because making a connection between a pictorial and a verbal representation of an item is proven to be an helpful way to store something in long term memory. You might expect that animated images are better than static images, but the research does not conclusively indicate that. Animated images could be more distracting and therefore less effective than static images. The exception is when demonstrating complex manual processes, where animations have shown to be effective. In my own work, I expect that I might try to use images that support the audio instead of purely decorative images or 'talking head' format. I'm thinking particularly of a lesson about building AI apps, where it would be helpful to show screenshots of important steps instead of just talking or writing about them. """,
            },
        ...
        "rubric": """
            ...
            2. Personal Example
                ...
                0 points - The user has not provided their own example of how they might use the multimedia principle in practice. 
            3. Animation vs Static
                1 points - The user has accurately spoken to when the multimedia principle advises when to use animation (primarily to illustrate hands-on procedures or to serve an interpretive function) vs static images (most other educational visualizations)
                0 points - The user has not spoken to when multimedia principle advises to use animation vs static images. 
        """,
        #"allow_revisions": True,
        "allow_skip": False,
...
PAGE_CONFIG = {
    "page_title": "Guided Critical Thinking",
    "page_icon": "️💡",
    "layout": "centered",
...
TEMPLATES = {"Guided Critical Thinking":"config_guided_critical_thinking"}
